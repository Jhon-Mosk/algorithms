...
/**
 * Registry
 * был применён для выбора подключаемого конфига и роутера
 * а так же для получения данных из конфига, и рендера определённой страницы, в зависимости от роутера
 */
